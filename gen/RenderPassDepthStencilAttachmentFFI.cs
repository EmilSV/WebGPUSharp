...
{
    /// <summary>
    /// A <see cref="FFI.TextureView"/>describing the texturesubresourcethat will be output to
    ...
    /// to prior to executing the render pass. Ignored if <see cref="FFI.RenderPassDepthStencilAttachment.DepthLoadOp"/>is not <see cref="LoadOp."clear""/>. Must be between 0.0 and 1.0, inclusive.
    /// </summary>
    public float DepthClearValue;
    /// <summary>
    /// Indicates that the depth component of <see cref="FFI.RenderPassDepthStencilAttachment.View"/>is read only.
    /// </summary>
    ...
    /// to prior to executing the render pass. Ignored if <see cref="FFI.RenderPassDepthStencilAttachment.StencilLoadOp"/>is not <see cref="LoadOp."clear""/>.
    /// The value will be converted to the type of the stencil aspect of |view| by taking the same
    /// number of LSBs as the number of bits in the stencil aspect of onetexelof |view|.
    /// </summary>
    public uint StencilClearValue = 0;
    /// <summary>
    /// Indicates that the stencil component of <see cref="FFI.RenderPassDepthStencilAttachment.View"/>is read only.
    /// </summary>
