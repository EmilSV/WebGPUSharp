...
public unsafe partial struct RenderPassEncoderHandle : IEquatable<RenderPassEncoderHandle>
{
    ...
    /// </remarks>
    /// <returns>The same <see cref="RenderPassEncoderHandle"/> instance with an incremented reference count.</returns>
    public RenderPassEncoderHandle AddRef()
    {
        WebGPU_FFI.RenderPassEncoderAddRef(this);
        return this;
    }
