...
public enum SType
{
    ShaderModuleSPIRVDescriptor = 1,
    ShaderModuleWGSLDescriptor = 2,
    PrimitiveDepthClipControl = 3,
    RenderPassDescriptorMaxDrawCount = 4,
    TextureBindingViewDimensionDescriptor = 131072,
    SurfaceDescriptorFromCanvasHTMLSelector = 262144,
    SurfaceDescriptorFromMetalLayer = 65536,
    SurfaceDescriptorFromWindowsHWND = 65537,
    SurfaceDescriptorFromXlibWindow = 65538,
    SurfaceDescriptorFromWaylandSurface = 65539,
    SurfaceDescriptorFromAndroidNativeWindow = 65540,
    SurfaceDescriptorFromXcbWindow = 65541,
