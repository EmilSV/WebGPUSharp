...
public partial struct Extent3D
{
    ...
    /// If used with a  <see cref="Texture"/> with a  <see cref="TextureDimension"/> of  <see cref="TextureDimension.D3"/>
    /// defines the depth of the texture. If used with a  <see cref="Texture"/> with a  <see cref="TextureDimension"/>
