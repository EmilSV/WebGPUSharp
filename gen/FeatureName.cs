...
public enum FeatureName
{
    ...
    /// occluders to be rendered into a tighter depth range. Supported platforms:<list type="bullet"><item><description>desktops</description></item><item><description>some mobile chips</description></item></list>
    /// </summary>
    DepthClipControl = 1,
    /// <summary>
    /// Allows for explicit creation of textures of format <see cref="TextureFormat.Depth32FloatStencil8" />.
    /// Supported platforms:<list type="bullet"><item><description>Vulkan (mostly)</description></item><item><description>DX12</description></item><item><description>Metal</description></item><item><description>OpenGL</description></item></list>
    /// </summary>
    ...
    /// 
    /// Support for this feature guarantees availability of <see cref="Webgpu.TextureUsage.CopySrc" />, <see cref="Webgpu.TextureUsage.CopyDst" /> or <see cref="Webgpu.TextureUsage.TextureBinding" /> for BCn formats. <see cref="FeatureName.TextureAdapterSpecificFormatFeatures" /> may enable additional usages.
    /// 
    /// This feature guarantees availability of sliced-3d textures for BC formats when combined with <see cref="FeatureName.TextureCompressionBcSliced3d" />.
    /// 
    ...
    /// Compressed textures sacrifice some quality in exchange for significantly reduced bandwidth usage.
    /// 
    /// Support for this feature guarantees availability of <see cref="Webgpu.TextureUsage.CopySrc" />, <see cref="Webgpu.TextureUsage.CopyDst" /> or <see cref="Webgpu.TextureUsage.TextureBinding" /> for ETC2 formats.
    /// <see cref="FeatureName.TextureAdapterSpecificFormatFeatures" /> may enable additional usages.
    /// 
    ...
    /// Compressed textures sacrifice some quality in exchange for significantly reduced bandwidth usage.
    /// 
    /// Support for this feature guarantees availability of <see cref="Webgpu.TextureUsage.CopySrc" />, <see cref="Webgpu.TextureUsage.CopyDst" /> or <see cref="Webgpu.TextureUsage.TextureBinding" /> for ASTC formats with Unorm/UnormSrgb channel type. <see cref="FeatureName.TextureAdapterSpecificFormatFeatures" /> may enable additional usages.
    /// 
    /// Supported Platforms:<list type="bullet"><item><description>Vulkan on Intel</description></item><item><description>Mobile (some)</description></item></list>
    /// </summary>
    ...
    /// 
    /// Supported Platforms:<list type="bullet"><item><description>Vulkan (mostly)</description></item><item><description>DX12</description></item><item><description>Metal on Apple3+ or Mac1+</description></item><item><description>OpenGL (Desktop 4.2+ with ARB_shader_draw_parameters only)</description></item></list>
    /// 
