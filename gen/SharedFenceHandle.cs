...
public readonly unsafe partial struct SharedFenceHandle : IEquatable<SharedFenceHandle>
{
    ...
    public void ExportInfo(SharedFenceExportInfo* info) => WebGPU_FFI.SharedFenceExportInfo(this, info);

    public void AddRef() => WebGPU_FFI.SharedFenceAddRef(this);

    public void Release() => WebGPU_FFI.SharedFenceRelease(this);
