...
public unsafe partial struct RenderPassColorAttachmentFFI
{
    ...
    /// <summary>
    /// A <see cref="FFI.TextureView"/>describing the texturesubresourcethat will be output to for this
    /// color attachment.
    /// </summary>
    public required TextureViewHandle View;
    /// <summary>
    /// Indicates the depth slice index of <see cref="TextureViewDimension."3d""/> <see cref="FFI.RenderPassColorAttachment.View"/>that will be output to for this color attachment.
    /// </summary>
    public uint DepthSlice;
    /// <summary>
    /// A <see cref="FFI.TextureView"/>describing the texturesubresourcethat will receive the resolved
    ...
    /// <summary>
    /// The store operation to perform on <see cref="FFI.RenderPassColorAttachment.View"/>after executing the render pass.
    /// </summary>
    ...
    /// render pass. If notprovided, defaults to `{r: 0, g: 0, b: 0, a: 0}`. Ignored
    ...
    /// They are convertedto a texel value of texture formatmatching the render attachment.
