...
public unsafe static partial class WebGPU_FFI
{
    ...
    /// is undefined.
    /// </summary>
    public const float DEPTH_CLEAR_VALUE_UNDEFINED = float.NaN;
    /// <summary>
    /// The const value use to indicate that the
    ...
    public static extern InstanceHandle CreateInstance(InstanceDescriptorFFI* descriptor);
    [DllImport("webgpu_dawn", EntryPoint = "wgpuGetInstanceFeatures", CallingConvention = CallingConvention.Cdecl)]
    public static extern void GetInstanceFeatures(SupportedInstanceFeaturesFFI* features);
    [DllImport("webgpu_dawn", EntryPoint = "wgpuGetInstanceLimits", CallingConvention = CallingConvention.Cdecl)]
    public static extern Status GetInstanceLimits(InstanceLimits* limits);
    [DllImport("webgpu_dawn", EntryPoint = "wgpuHasInstanceFeature", CallingConvention = CallingConvention.Cdecl)]
    public static extern WebGPUBool HasInstanceFeature(InstanceFeatureName feature);
    /// <summary>
    ...
    public static extern Future AdapterRequestDevice(AdapterHandle adapter, DeviceDescriptorFFI* descriptor, RequestDeviceCallbackInfoFFI callbackInfo);
    /// <summary>
    ...
    /// </summary>
    /// <param name="adapterInfo">The <see cref="AdapterInfoFFI" /> to free.</param>
    [DllImport("webgpu_dawn", EntryPoint = "wgpuAdapterInfoFreeMembers", CallingConvention = CallingConvention.Cdecl)]
    public static extern void AdapterInfoFreeMembers(AdapterInfoFFI adapterInfo);
    /// <summary>
    ...
    [DllImport("webgpu_dawn", EntryPoint = "wgpuComputePassEncoderSetImmediates", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ComputePassEncoderSetImmediates(ComputePassEncoderHandle computePassEncoder, uint offset, void* data, nuint size);
    /// <summary>
    /// Set debug label of this command encoder.
    /// </summary>
    /// <param name="computePassEncoder">The compute pass encoder</param>
    ...
    public static extern void ExternalTextureSetLabel(ExternalTextureHandle externalTexture, StringViewFFI label);
    [DllImport("webgpu_dawn", EntryPoint = "wgpuExternalTextureAddRef", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ExternalTextureAddRef(ExternalTextureHandle externalTexture);
    ...
    public static extern void InstanceGetWGSLLanguageFeatures(InstanceHandle instance, SupportedWGSLLanguageFeaturesFFI* features);
    /// <summary>
    ...
    [DllImport("webgpu_dawn", EntryPoint = "wgpuRenderBundleEncoderSetImmediates", CallingConvention = CallingConvention.Cdecl)]
    public static extern void RenderBundleEncoderSetImmediates(RenderBundleEncoderHandle renderBundleEncoder, uint offset, void* data, nuint size);
    /// <summary>
    ...
    [DllImport("webgpu_dawn", EntryPoint = "wgpuRenderPassEncoderSetImmediates", CallingConvention = CallingConvention.Cdecl)]
    public static extern void RenderPassEncoderSetImmediates(RenderPassEncoderHandle renderPassEncoder, uint offset, void* data, nuint size);
    /// <summary>
    /// Sets the active index buffer.
    /// 
    ...
    /// After calling this function, using the members will lead to undefined behavior.
    /// </summary>
    /// <param name="supportedFeatures">The <see cref="SupportedFeaturesFFI" /> to free.</param>
    [DllImport("webgpu_dawn", EntryPoint = "wgpuSupportedFeaturesFreeMembers", CallingConvention = CallingConvention.Cdecl)]
    public static extern void SupportedFeaturesFreeMembers(SupportedFeaturesFFI supportedFeatures);
    [DllImport("webgpu_dawn", EntryPoint = "wgpuSupportedInstanceFeaturesFreeMembers", CallingConvention = CallingConvention.Cdecl)]
    public static extern void SupportedInstanceFeaturesFreeMembers(SupportedInstanceFeaturesFFI supportedInstanceFeatures);
    /// <summary>
    /// Free members of a
    ...
    /// After calling this function, using the members will lead to undefined behavior.
    /// </summary>
    /// <param name="supportedWGSLLanguageFeatures">The <see cref="SupportedWGSLLanguageFeaturesFFI" /> to free.</param>
    [DllImport("webgpu_dawn", EntryPoint = "wgpuSupportedWGSLLanguageFeaturesFreeMembers", CallingConvention = CallingConvention.Cdecl)]
    public static extern void SupportedWGSLLanguageFeaturesFreeMembers(SupportedWGSLLanguageFeaturesFFI supportedWGSLLanguageFeatures);
    /// <summary>
    ...
    public static extern Status SurfacePresent(SurfaceHandle surface);
    /// <summary>
    ...
    /// After calling this function, using the members will lead to undefined behavior.
    /// </summary>
    /// <param name="surfaceCapabilities">The <see cref="SurfaceCapabilitiesFFI" /> to free.</param>
    ...
    public static extern void SurfaceCapabilitiesFreeMembers(SurfaceCapabilitiesFFI surfaceCapabilities);
    /// <summary>
    ...
    [DllImport("webgpu_dawn", EntryPoint = "wgpuTextureGetTextureBindingViewDimension", CallingConvention = CallingConvention.Cdecl)]
