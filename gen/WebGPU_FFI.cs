...
public unsafe static partial class WebGPU_FFI
{
    ...
    public static extern void CommandEncoderInjectValidationError(FFI.CommandEncoderHandle commandEncoder, FFI.StringViewFFI message);
    ...
    public static extern FFI.ShaderModuleHandle DeviceCreateErrorShaderModule(FFI.DeviceHandle device, FFI.ShaderModuleDescriptorFFI* descriptor, FFI.StringViewFFI errorMessage);
    ...
    public static extern void DeviceForceLoss(FFI.DeviceHandle device, DeviceLostReason type, FFI.StringViewFFI message);
    ...
    public static extern void DeviceInjectError(FFI.DeviceHandle device, ErrorType type, FFI.StringViewFFI message);
    ...
    public static extern void DeviceSetLoggingCallback(FFI.DeviceHandle device, delegate* unmanaged[Cdecl]<LoggingType, FFI.StringViewFFI, void*, void> callback, void* userdata);
    ...
    public static extern void ExternalTextureSetLabel(FFI.ExternalTextureHandle externalTexture, FFI.StringViewFFI label);
    ...
    public static extern void SharedBufferMemorySetLabel(FFI.SharedBufferMemoryHandle sharedBufferMemory, FFI.StringViewFFI label);
    ...
    public static extern void SharedTextureMemorySetLabel(FFI.SharedTextureMemoryHandle sharedTextureMemory, FFI.StringViewFFI label);
